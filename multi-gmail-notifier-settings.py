...
class Settings(object):
    ...
    def set_initial_state(self):
        self.set_entry_text('', '', '')
        self.set_entry_editable(False, False, False)
    ...
    def set_entry_text(self, username, password, uri):
    ...
    def set_entry_editable(self, username, password, uri):
    ...
    def on_users_list_cursor_changed(self, widget, data=None):
        ...
        if row is not None:
            ...
            self.set_entry_editable(True, True, True)
    ...
    def on_save_clicked(self, widget, data=None):
        ...
        if not ue.get_text() or not pe.get_text() or not ri.get_text():
            ...
            if row is not None:
                ...
                model.append(None, [ue.get_text(), pe.get_text(), ri.get_text()])
...
if __name__ == "__main__":
    ...
    settings = Settings(APP_NAME, APP_PASS)
    settings.show()
